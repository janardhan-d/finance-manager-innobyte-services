# 🌟 Finance Manager — InnoByte Services Internship Project  
A modern, neon‑themed **Personal Finance Manager** built during my internship at **InnoByte Services**.  
This application helps users track income, expenses, budgets, reports, and financial insights — all wrapped in a premium frosted‑glass UI.
